...
export default function StickyActionBar({
  ...
  const waUrl = whatsappNumber
    ? `https://wa.me/${whatsappNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(`Hello! I'd like to know more about ${businessName}.`)}`
    : null;
    ...
    >
      <div className="flex border-t border-white/10 shadow-[0_-4px_24px_rgba(0,0,0,0.18)]" style={{ backgroundColor: primaryColor }}>
        ...
        {phone ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-1 py-3 text-white/30">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            <span className="text-[11px] font-semibold tracking-wide">Call Us</span>
        ...
        {/* Divider */}
        {waUrl && <div className="w-px bg-white/15 my-2" />}
      ...
      <div className="h-safe-bottom" style={{ backgroundColor: primaryColor }} />
    </div>
  );
}
