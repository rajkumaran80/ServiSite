...
class TenantService {
  ...
  async setCustomDomain(tenantId: string, domain: string): Promise<{
    aRecords: Array<{ name: string; value: string; type: string }>;
    cnameRecord: { name: string; value: string; type: string };
